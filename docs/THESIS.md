...
- **L4 Optional adapter** — small learned bridges / seed expanders (e.g. visual seed code to fuller decoder-native token grids), shipped beside codecs, not inside the base model.
