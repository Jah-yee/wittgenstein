...
| K   | [Orchestration prior art](K_orchestration_prior_art.md)                        | Which 2026 orchestration / harness primitives (Symphony / Trellis / Anthropic) should Wittgenstein adopt?      | 🟢 Ratified by ADR-0017 |
| L   | [Sensor codec landscape](L_sensor_codec_landscape.md)                          | Should v0.4+ sensor adopt deterministic chaotic operators / TimesFM-class models / non-linear quality metrics? | 🟡 Draft v0.1           |
