...
| patchGrammar measurement plan | PR #295 (pending) | Proposed dataset / metric / protocol for the #284 measurement gate. Treat the current lane mix and thresholds as draft until the PR lands. |
