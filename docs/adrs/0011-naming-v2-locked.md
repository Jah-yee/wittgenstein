...
- **Adapter** — L4: small learned bridge shipped beside a Codec (e.g. a seed expander / visual-code compiler for image). Optional; absent for rule-based modalities.
...
- `docs/inheritance-audit.md` N-3 (naming) moves from _revise_ to _resolved_.
