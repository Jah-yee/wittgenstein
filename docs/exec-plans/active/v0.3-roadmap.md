...
Current-stage repo cleanup:

- **#159** — refresh this roadmap index after `#116` merged and `#118` unblocked
- **#160** — refresh `docs/implementation-status.md` after Slice C2 merge
- **#161** — queue audit for stale closures, drift, and current-stage priority
