...
- **Spec** — the structured modality contract that the LLM is asked to produce before decoding. It may contain human-readable semantic IR, compact visual seed code, or other typed modality sections.
...
- **Adapter** — the optional L4 learned bridge / seed expander between symbolic plans or compact code and decoder inputs.
