import type { WittgensteinCodec, RenderCtx, RenderResult, SensorRequest } from "@wittgenstein/schemas";
...
export const sensorCodec: WittgensteinCodec<SensorRequest, SensorSignalSpec> = {
  name: "sensor",
