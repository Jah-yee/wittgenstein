# Wittgenstein / Modality Harness — Research Reference Dossier
...
- Why it matters:
  ...
  - This supports the design choice to keep Wittgenstein’s runtime modular and codec-based instead of inventing an over-generalized mega-framework.
...
- What Wittgenstein should borrow:
  - `AGENTS.md` as map,
...
- Why that helps your project:
  - It legitimizes talking about Wittgenstein as a *modality harness* or *modality layer* rather than merely a script collection.
...
- Why it matters:
  ...
  - This maps almost perfectly to Wittgenstein’s desired operational style.
- Most relevant factors for Wittgenstein:
  - own prompts,
  - own context window,
...
Wittgenstein extends this shift into the **output-modality** dimension.
...
- Important difference:
  ...
  - Wittgenstein tries to defer more of it into the harness layer.
...
- Better use of MiniMax in the story:
  ...
  - “compatible backend,”
  - “evidence that harness-capable runtimes are a natural environment for Wittgenstein.”
...
- Relevance to Wittgenstein pitch:
